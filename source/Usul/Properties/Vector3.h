...
template <> struct Getter < Usul::Math::Vec3d >
{
...
template <> struct Getter < Usul::Math::Vec3f >
{
...
template <> struct Require < Usul::Math::Vec3d >
{
...
template <> struct Require < Usul::Math::Vec3f >
{
